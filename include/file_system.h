...
public:
	...
	std::vector<std::string>& getInDir(const char* directory, bool filesOnly = true, bool fullPath = false, bool extension = true, std::vector<std::string> acceptedExtensions = {});
	std::vector<std::string>& getInDirRecursive(const char* directory, bool filesOnly = true, bool fullPath = false, bool extension = true, std::vector<std::string> acceptedExtensions = {});
